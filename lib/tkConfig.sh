...
# installed.
TK_PREFIX='/media/psf/Home/coding/ns-allinone-2.35-github'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/media/psf/Home/coding/ns-allinone-2.35-github'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/media/psf/Home/coding/ns-allinone-2.35-github/tk8.5.10/unix -ltk8.5'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/media/psf/Home/coding/ns-allinone-2.35-github/lib -ltk8.5'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/media/psf/Home/coding/ns-allinone-2.35-github/include'
...
# compiled.
TK_SRC_DIR='/media/psf/Home/coding/ns-allinone-2.35-github/tk8.5.10'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/media/psf/Home/coding/ns-allinone-2.35-github/tk8.5.10/unix -ltkstub8.5'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/media/psf/Home/coding/ns-allinone-2.35-github/lib -ltkstub8.5'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/media/psf/Home/coding/ns-allinone-2.35-github/tk8.5.10/unix/libtkstub8.5.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/media/psf/Home/coding/ns-allinone-2.35-github/lib/libtkstub8.5.a'
